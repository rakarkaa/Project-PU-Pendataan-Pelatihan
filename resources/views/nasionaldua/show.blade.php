...
@section('konten')
            ...
            <div class="row">
                <div class="container-sm shadow-sm p-3 mb-5 bg-body rounded">
                    <div class="card">
                        <div class="card-header">Daftar Data Pelatihan Kepemimpinan Nasional Tingkat 2</div>
                        ...
                        <a href="/nasionaldua/create" class="btn btn-primary" type="button">Tambah Data</a>
                        </div>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        ...
                                        <a href="/nasionaldua/{{$item->id}}/edit" class="btn btn-warning">edit</a>
                                    </td>
                                    </tr>
            ...
            <div class="modal fade" id="modalHapus_{{$item->id}}" tabindex="-1" aria-labelledby="modalHapusLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form action="/nasionaldua/{{$item->id}}" method="POST">
