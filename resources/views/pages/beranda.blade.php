                    ...
                    <div class="row"> <div class="row"> 
                        <div class="col-lg-12"> 
                            <div class="card shadow h-100 py-2"> 
                                <div class="card-body"> <div class="card-title p-2"> 
                                    <h5 class="font-weight-bold text-gray-800">Selamat datang, Perlu Mendata Hari ini?</h5> 
                                </div> 
                                <div class="col-lg-7 offset-lg-2"> 
                                    <img src="{{ asset('assets/img/hello.svg') }}" alt="" class="img-fluid"> 
                                </div> 
                            </div> 
                        </div> 
                    </div> 
