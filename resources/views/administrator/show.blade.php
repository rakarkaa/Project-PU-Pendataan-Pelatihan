...
@section('konten')
            ...
            <div class="row">
                <div class="container-sm shadow-sm p-3 mb-5 bg-body rounded">
                    <div class="card">
                        <div class="card-header">Daftar Data Pelatihan Kepemimpinan Administrator</div>
                        ...
                        <a href="/administrator/create" class="btn btn-primary" type="button">Tambah Data</a>
                        </div>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        ...
                                        <a href="/administrator/{{$item->id}}/edit" class="btn btn-warning">edit</a>
                                    </td>
                                    </tr>
